...
import { addNote, updateDraftNoteBody, updateDraftNoteTitle } from '../reducers/imageNotes';
        ...
        <div>
            {(() => {
                if(reportId !== -1) {
                    ...
                    return (<div className="card mt-3 p-3 pr-0 grid grid-cols-12 divide-x w-full">
                                <div className="col-span-11">
                                    <input onChange={(e) => onChangeTitle(e)} value={title} className="shadow-md appearance-none rounded py-1 px-3 mb-3 w-5/6 text-black font-bold h2"/>
                                    <textarea onChange={(e) => onChangeBody(e)} value={body} rows="2" className="resize-none shadow-md appearance-none rounded py-1 px-3 w-5/6 text-black"/>
                                </div>
                                <div className="py-8">
                                    <button className="text-red-500 p-0 mx-2 shadow-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
